...
downloadBinary('stockfish', {
  ...
  mac: os.arch() === 'arm64'
    ? { url: 'https://github.com/official-stockfish/Stockfish/releases/download/sf_17/stockfish-macos-m1-apple-silicon.tar', kind: 'tar', entry: 'stockfish/stockfish-macos-m1-apple-silicon' }
    : { url: 'https://github.com/official-stockfish/Stockfish/releases/download/sf_17/stockfish-macos-x86-64-avx2.tar', kind: 'tar', entry: 'stockfish/stockfish-macos-x86-64-avx2' }
})
